...
public class MoveWest implements CommandInterface {
	...
	@Override
	public void execute() {
		System.out.println(pfixLog + "PLAYER : " + player.getName() + " - " + "Moving WEST by 1 unit.");
	...
	@Override
	public boolean undo() {
		System.out.println(pfixLog + "PLAYER : " + player.getName() + " - " + "Undoing move from WEST by 1 unit.");
		player.addToXCoord(1);
		System.out.println(pfixLog + "PLAYER : " + player.getName() + " - " + "Latest coordinate at (" + player.getxCoord() + " , " + player.getyCoord() + ")");
		return true;
	}
